...
static LPCSTR		g_lpcszClassName = "BroadcastCheckWnd";
...
void Initialize_OrgWsa( HWND hWnd)
{
	...
	if( 0 != at)
	{
		g_hWndforOrgWsa = CreateWindow( g_lpcszClassName, "forOrgSelectBrdcst", WS_CHILD, 0, 0, 0, 0, hWnd, ( HMENU)NULL, ( HINSTANCE)g_hModule, NULL);
#ifdef	_DEBUG
